...
def main() -> None:
    ...
    train_dataset = train_dataset.select(range(125000))  # first 100000 samples
    eval_dataset = eval_dataset.select(range(12500))    # first 10000 samples
