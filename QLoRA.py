...
def main() -> None:
    ...
    train_dataset = train_dataset.select(range(15000))  # first 50 samples
    eval_dataset = eval_dataset.select(range(1500))    # first 10 samples
    ...
    training_args = TrainingArguments(
        ...
        warmup_ratio = 0.085,
        logging_steps=4, #change to 10 later
        save_strategy="epoch",
        eval_strategy="steps",
        eval_steps = 8,
