...
def main() -> None:
    ...
    train_dataset = train_dataset.select(range(50000))  # first 50 samples
    eval_dataset = eval_dataset.select(range(10000))    # first 10 samples
